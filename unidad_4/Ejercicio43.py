...
class RegistroAlumnos(QWidget):
    ...
    def __init__(self):
        ...
        self.edad_edit.setValidator(None)  # puedes usar QIntValidator para restringir números
    ...
    def guardar_alumno(self):
        ...
        # Guardar en archivo
        linea = f"{alumno.nombre} – {alumno.carrera} – {alumno.edad} años\n"
        try:
            with self.ruta_archivo.open("a", encoding="utf-8") as f:
                f.write(linea)
        except OSError as e:
            QMessageBox.critical(
                self, "Error de escritura",
...
if __name__ == "__main__":
    ...
    # Se agregoun atributo al objeto Alumno de Edad. Si es mayor de edad que imprima un mensaje